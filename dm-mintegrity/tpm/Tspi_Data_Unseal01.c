...
int main_v1_1(char *data)
{
	...
	BYTE *rgbPcrValue;
	BYTE *newvalue="11111111111111111111";
	int PCR_result_length;
	...
	strncpy(rgbDataToSeal, data, DATA_SIZE);
	printf("Sealing data %s\n", rgbDataToSeal);
	// Create Context
...
#ifdef ATTACK
       result = Tspi_TPM_PcrExtend(hTPM, PCR_NUM, ulPcrLen, rgbPcrValue, NULL, &PCR_result_length, &Final_PCR_Value);
        if (result != TSS_SUCCESS) {
