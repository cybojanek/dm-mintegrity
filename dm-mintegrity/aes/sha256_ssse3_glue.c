...
static int sha256_ssse3_init(struct shash_desc *desc)
{
	...
	//printk(KERN_ALERT" inside sha256_ssse3_init");
			       ...
			       unsigned int len, unsigned int partial)
{
	...
	//printk(KERN_ALERT" inside __sha256_ssse3_update ");
	sctx->count += len;
			     ...
			     unsigned int len)
{
	...
	//printk(KERN_ALERT" inside sha256_ssse3_update ");
...
static int sha256_ssse3_final(struct shash_desc *desc, u8 *out)
{
	...
	//printk(KERN_ALERT" inside sha256_ssse3_final ");
