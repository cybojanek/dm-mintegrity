...
mkfs_commands["ext4_combo_regular"]="mke2fs -O journal_dev -F -E lazy_journal_init=1 ${SSD} && sudo mke2fs -t ext4 -F -E lazy_itable_init=0 -J device=${SSD}"
mkfs_commands["ext4_combo_journal"]="mke2fs -O journal_dev -F -E lazy_journal_init=1 ${SSD} && sudo mke2fs -t ext4 -F -E lazy_itable_init=0 -J device=${SSD}"
...
mount_commands["ext4_combo_regular"]="-t ext4 -o noatime,journal_async_commit"
mount_commands["ext4_combo_journal"]="-t ext4 -o noatime,journal_async_commit,nodelalloc,data=journal"
...
file_systems["none_combo"]="ext4_combo_regular ext4_combo_journal"
...
MODES="none_hdd full_hdd none_ssd full_ssd none_combo full_shdd"
